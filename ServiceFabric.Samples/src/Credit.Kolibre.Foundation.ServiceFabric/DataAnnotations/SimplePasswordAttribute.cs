...
// File             : SimplePasswordAttribute.cs
// Created          : 2016-07-01  11:35 AM
// ***********************************************************************
// <copyright>
...
namespace Credit.Kolibre.Foundation.ServiceFabric.DataAnnotations
{
    ...
    public sealed class SimplePasswordAttribute : DataTypeAttribute
    {
        private static readonly Regex s_regex = REGEX.SIMPLE_PASSWORD_REGEX;

        public SimplePasswordAttribute() : base(DataType.Password)
        {
        }
