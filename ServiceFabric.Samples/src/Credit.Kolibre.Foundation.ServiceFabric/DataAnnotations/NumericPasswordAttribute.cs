...
// File             : NumericPasswordAttribute.cs
...
namespace Credit.Kolibre.Foundation.ServiceFabric.DataAnnotations
{
    ...
    public sealed class NumericPasswordAttribute : DataTypeAttribute
    {
        private static readonly Regex s_regex = REGEX.NUMERIC_PASSWORD_REGEX;

        public NumericPasswordAttribute() : base(DataType.Password)
        {
        }
