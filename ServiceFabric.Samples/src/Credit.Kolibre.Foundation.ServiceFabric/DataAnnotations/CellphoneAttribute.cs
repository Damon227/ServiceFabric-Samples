...
// File             : CellphoneAttribute.cs
// Created          : 2016-07-01  11:59 AM
// ***********************************************************************
// <copyright>
...
namespace Credit.Kolibre.Foundation.ServiceFabric.DataAnnotations
{
    ...
    {
        private static readonly Regex s_regex = REGEX.CELLPHONE_REGEX;

        public CellphoneAttribute() : base(DataType.PhoneNumber)
        {
        }
