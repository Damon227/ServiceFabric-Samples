...
namespace Credit.Kolibre.Foundation.ServiceFabric.Identity
{
    public static class ClaimTypes
    {
        ...
        /// <summary>The URI for a claim that specifies the home cellphone of an entity, http://schemas.xmlsoap.org/ws/2005/05/identity/claims/homephone.</summary>
        ...
        /// <summary>The URI for a claim that specifies the mobile cellphone of an entity, http://schemas.xmlsoap.org/ws/2005/05/identity/claims/mobilephone.</summary>
        ...
        /// <summary>The URI for a claim that specifies the alternative cellphone of an entity, http://schemas.xmlsoap.org/ws/2005/05/identity/claims/otherphone.</summary>
