...
//        private static readonly int s_initializedFilesCleanupPeriod = 2;
...
//        /// </summary>
//        private static readonly int s_initializedFilesCounterMax = 100;

//        /// <summary>
//        ///     This value disables file archiving based on the size.
//        /// </summary>
//        private static readonly int s_archiveAboveSizeDisabled = -1;

//        /// <summary>
//        ///     Holds the initialised files each given time by the <see cref="FileLogger" /> instance. Against each file, the last write time is stored.
//        /// </summary>
//        /// <remarks>Last write time is store in local time (no UTC).</remarks>
//        private readonly Dictionary<string, DateTime> _initializedFiles = new Dictionary<string, DateTime>();

//        /// <summary>
//        ///     Factory used to create the file appenders in the <see cref="FileLogger" /> instance.
//        /// </summary>
...
//        /// </summary>
//        private readonly Queue<string> previousFileNames;
...
//            OpenFileCacheSize = 5;
//            CreateDirs = true;
//            fileArchive = new DynamicFileArchive(this, MaxArchiveFiles);
//            ForceManaged = false;
//            ArchiveDateFormat = string.Empty;

//            maxLogFilenames = 20;
//            previousFileNames = new Queue<string>(maxLogFilenames);
//            fileAppenderCache = FileAppenderCache.Empty;
...
//        {
//            get { return LineEnding.NewLineCharacters; }
//        }
...
//                        fileAppenderCache.ArchiveFilePatternToWatch = fileNamePattern;
...
//                                        lock (SyncRoot)
//                                        {
//                                            fileAppenderCache.InvalidateAppendersForInvalidFiles();
//                                        }
//                                    }
//                                    catch (Exception ex)
//                                    {
...
//                else
//                {
//                    fileAppenderCache.ArchiveFilePatternToWatch = null;
...
//        {
//            CleanupInitializedFiles(DateTime.UtcNow.AddDays(-FileTarget.InitializedFilesCleanupPeriod));
//        }
...
//        {
//            List<string> filesToFinalize = new List<string>();

//            // Select the files require to be finalized.
//            foreach (KeyValuePair<string, DateTime> file in _initializedFiles)
//            {
...
//        {
//            return ArchiveAboveSize != FileTarget.ArchiveAboveSizeDisabled ||
//                   ArchiveEvery != FileArchivePeriod.None;
//        }
...
//            RefreshFileArchive();
//            appenderFactory = GetFileAppenderFactory();

//            fileAppenderCache = new FileAppenderCache(OpenFileCacheSize, appenderFactory, this);
//            RefreshArchiveFilePatternToWatch();
...
//        {
//            string fullFileName = GetFullFileName(logEvent);
...
//                return null;
//            }
//            return fullFileName.Render(logEvent);
//        }
...
//        {
//            var buckets = logEvents.BucketSort(c => GetFullFileName(c.LogEvent));
...
//            WriteToFile(fileName, logEvent, bytesToWrite, false);
...
//        {
//            if (ShouldDeleteOldArchives() && archiveNumber >= MaxArchiveFiles)
//            {
...
//            string fileNameMask = fileTemplate.ReplacePattern("*");
//            string dateFormat = GetArchiveDateFormatString(ArchiveDateFormat);
...
//        ///     <see
//        ///         cref="P:FileTarget.MaxArchiveFiles" />
//        ///     setting.
//        /// </summary>
//        /// <param name="oldArchiveFileNames">List of the file archives.</param>
//        /// <remarks>
//        ///     Items are deleted in the same order as in <paramref name="oldArchiveFileNames" />. No file is deleted if
//        ///     <see
//        ///         cref="P:FileTarget.MaxArchiveFiles" />
//        ///     property is zero.
//        /// </remarks>
...
//        ///     prior period (Year, Month, Day, Hour, Minute) datetime. When the number of archive files exceed
//        ///     <see
//        ///         cref="P:MaxArchiveFiles" />
//        ///     the obsolete archives are deleted.
//        /// </summary>
//        /// <param name="fileName">File name to be archived.</param>
//        /// <param name="pattern">File name template which contains the numeric pattern to be replaced.</param>
//        /// <param name="logEvent">Log event that the <see cref="FileTarget" /> instance is currently processing.</param>
...
//        /// <summary>
//        ///     Gets the correct formatting <see langword="String" /> to be used based on the value of
//        ///     <see
//        ///         cref="P:ArchiveEvery" />
...
//        {
//            var lastWriteTimeUtc = fileAppenderCache.GetFileLastWriteTimeUtc(fileName, true);
...
//            {
//                case FileArchivePeriod.Year:
//                    periodAfterPreviousLogEventTime = previousLogEventTimestamp.Value.AddYears(1);
//                    break;
//                case FileArchivePeriod.Month:
//                    periodAfterPreviousLogEventTime = previousLogEventTimestamp.Value.AddMonths(1);
//                    break;
//                case FileArchivePeriod.Day:
//                    periodAfterPreviousLogEventTime = previousLogEventTimestamp.Value.AddDays(1);
//                    break;
//                case FileArchivePeriod.Hour:
//                    periodAfterPreviousLogEventTime = previousLogEventTimestamp.Value.AddHours(1);
//                    break;
//                case FileArchivePeriod.Minute:
//                    periodAfterPreviousLogEventTime = previousLogEventTimestamp.Value.AddMinutes(1);
//                    break;
//                default:
//                    return false;
//            }
...
//                {
//                    if (_initializedFiles.ContainsKey(fileInfo.FullName))
//                    {
//                        _initializedFiles.Remove(fileInfo.FullName);
//                    }
//                }
//            }
//            else
...
//                        RollArchivesForward(fileInfo.FullName, fileNamePattern, 0);
//                        break;

//                    case ArchiveNumberingMode.Sequence:
//                        ArchiveBySequence(fileInfo.FullName, fileNamePattern);
//                        break;

//#if !NET_CF
//                    case ArchiveNumberingMode.Date:
//                        ArchiveByDate(fileInfo.FullName, fileNamePattern, eventInfo);
//                        break;

//                    case ArchiveNumberingMode.DateAndSequence:
//                        ArchiveByDateAndSequence(fileInfo.FullName, fileNamePattern, eventInfo);
//                        break;
//#endif
//                }
//            }
...
//            string archiveFileName = fullarchiveFileName.Render(eventInfo);
...
//        {
//            string archiveFile = GetArchiveFileName(fileName, ev, upcomingWriteSize);
//            if (!string.IsNullOrEmpty(archiveFile))
//            {
//#if !SILVERLIGHT
//                Mutex archiveMutex = fileAppenderCache.GetArchiveMutex(fileName);
//                try
//                {
...
//        {
//            bool hasFileName = !(fileName == null && previousLogFileName == null);
//            if (hasFileName)
//            {
...
//            var fileLength = fileAppenderCache.GetFileLength(fileName, true);
...
//        {
//            if (ArchiveAboveSize == s_archiveAboveSizeDisabled)
//            {
//                return null;
//            }
...
//            var length = fileAppenderCache.GetFileLength(fileName, true);
//            if (length == null)
//            {
//                return null;
//            }

//            bool shouldArchive = length.Value + upcomingWriteSize > ArchiveAboveSize;
//            if (shouldArchive)
//            {
//                return fileName;
//            }
...
//            var creationTimeUtc = fileAppenderCache.GetFileCreationTimeUtc(fileName, true);
...
//            bool shouldArchive = fileCreated != logEventRecorded;
//            if (shouldArchive)
//            {
//                return fileName;
//            }
...
//                    fileAppenderCache.CloseAppenders(expireTime);
//                }
//                catch (Exception exception)
//                {
...
//        {
//            return GetLayoutBytes(this.Header);
//        }
...
//        {
//            return GetLayoutBytes(this.Footer);
//        }
...
//            BaseFileAppender appender = fileAppenderCache.AllocateAppender(fileName);
...
//                    if (initializedFilesCounter >= FileTarget.InitializedFilesCounterMax)
//                    {
...
//            fileAppenderCache.InvalidateAppender(fileName);
...
//        ///     <see
//        ///         cref="P:NLog.Targets.FileTarget.ArchiveOldFileOnStartup" />
//        ///     and
//        ///     <see
//        ///         cref="P:NLog.Targets.FileTarget.DeleteOldFileOnStartup" />
...
//                {
//                    string archiveFileName = archiveFileQueue.Dequeue();
...
//            public FileLogger(string name, Func<string, LogLevel, bool> filter) : base(name, filter)
//            {
//            }

//            public FileLogger(string name, Func<string, LogLevel, bool> filter, Func<string> operationIdAccessor) : base(name, filter, operationIdAccessor)
//            {
//            }

//            public FileLogger(string name, Func<string, LogLevel, bool> filter, IOperationIdAccessor operationIdAccessor) : base(name, filter, operationIdAccessor)
//            {
//            }
