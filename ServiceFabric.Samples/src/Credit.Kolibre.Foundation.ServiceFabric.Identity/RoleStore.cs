...
namespace Credit.Kolibre.Foundation.ServiceFabric.Identity
{
    ...
    {
        public RoleStore(DbContext context, ErrorDescriber describer = null) : base(context, describer)
        {
        }
    }
    ...
    {
        public RoleStore(TContext context, ErrorDescriber describer = null) : base(context, describer)
        {
        }
    }
        ...
        where TContext : DbContext
    {
        ...
        {
            return new IdentityRoleClaim<TKey> { RoleId = role.RoleId, ClaimType = claim.Type, ClaimValue = claim.Value };
        }
    }
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>
    {
        ...
        protected RoleStore(TContext context, ErrorDescriber describer = null)
        {
            if (context == null)
            {
        ...
        /// <returns>A <see cref="Task{TResult}" /> that represents the <see cref="Result" /> of the asynchronous query.</returns>
        public virtual async Task<Result> CreateAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken" /> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>A <see cref="Task{TResult}" /> that represents the <see cref="Result" /> of the asynchronous query.</returns>
        public virtual async Task<Result> UpdateAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            if (role == null)
            ...
            Context.Attach(role);
            role.ConcurrencyStamp = Guid.NewGuid().ToGuidString();
            Context.Update(role);
            try
            {
                await SaveChanges(cancellationToken);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken" /> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>A <see cref="Task{TResult}" /> that represents the <see cref="Result" /> of the asynchronous query.</returns>
        public virtual async Task<Result> DeleteAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            if (role == null)
        ...
        public virtual Task<TRole> FindByIdAsync(string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            TKey roleId = ConvertIdFromString(id);
            return Roles.FirstOrDefaultAsync(u => u.RoleId.Equals(roleId), cancellationToken);
        }
        ...
        public async Task<IList<Claim>> GetClaimsAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await RoleClaims.Where(rc => rc.RoleId.Equals(role.RoleId)).Select(c => new Claim(c.ClaimType, c.ClaimValue)).ToListAsync(cancellationToken);
        }
        ...
        public async Task RemoveClaimAsync(TRole role, Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            List<TRoleClaim> claims = await RoleClaims.Where(rc => rc.RoleId.Equals(role.RoleId) && rc.ClaimValue == claim.Value && rc.ClaimType == claim.Type).ToListAsync(cancellationToken);
