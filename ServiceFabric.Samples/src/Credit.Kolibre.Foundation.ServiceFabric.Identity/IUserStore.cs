...
namespace Credit.Kolibre.Foundation.ServiceFabric.Identity
{
    ...
    public interface IUserStore<TUser> : IDisposable where TUser : class
    {
        ...
        Task<Result> CreateAsync(TUser user, CancellationToken cancellationToken);
        ...
        Task<Result> DeleteAsync(TUser user, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken" /> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation, containing the <see cref="Result" /> of the update operation.</returns>
        Task<Result> UpdateAsync(TUser user, CancellationToken cancellationToken);
    }
}